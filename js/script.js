...
define('data/Upgrades',[],function () {
	return [
		...
		},
		{
			...
			description: "Bacterial Lightbulbs are <strong>twice</strong> as efficient.<br><q>Get laid, get paid, get high and go die.</q>",
			cost: 15000000,
			boost: ['bacteriallightbulb', 3],
		...
		// dinosaur
		{
			...
			description: 'Dinosaur Lightbulbs are <strong>twice</strong> as efficient.<br><q>The essential particle of creation, now in dinosaur form</q>',
		...
		},
		{
			...
			cost: 5000000,
			boost: ['dinosaurlightbulb', 'x2'],
			description: "Dinosaur Lightbulbs are <strong>twice</strong> as efficient.<br><q>You could quantize my lightbulbs goodbye.</q>",
		...
		// levels
		{
			...
			cost: 1024,
			description: "Buildings are <strong>1%</strong> more efficient per levels.",
			boost: ['level', 0.01],
			displayAt: ['level', 5]
		},
		{
			...
			cost: 2560,
			description: "Buildings are <strong>2%</strong> more efficient per levels.",
			boost: ['level', 0.02],
			displayAt: ['level', 10]
		},
		{
			name: 'Energy Level Leaper',
			cost: 1024000,
			description: "Buildings are <strong>5%</strong> more efficient per levels.",
			boost: ['level', 0.05],
			displayAt: ['level', 20]
		},
		{
			...
			cost: 20480000,
			description: "Buildings are <strong>10%</strong> more efficient per levels.",
			boost: ['level', 0.1],
			displayAt: ['level', 30]
		},
		{
			name: 'Level Manipulation Unit',
			cost: 409600000,
			description: "Buildings are <strong>25%</strong> more efficient per levels.",
			boost: ['level', 0.25],
			displayAt: ['level', 45]
		},
		{
			...
			cost: 8192000000,
			description: "Buildings are <strong>50%</strong> more efficient per levels.",
			boost: ['level', 0.50],
			displayAt: ['level', 50]
		},
		// clicks
		...
		},
		{
			name:'Taoism',
			cost: 400,
			description: "The mouse gains <strong>+0.2</strong> volts per clicks.<br><q>Two powers are better than one.</q>",
			boost: ['click', 0.2],
			displayAt: ['click', 100]
		},
		{
...
define('views/UpgradeView',['underscore', 'backbone', 'utils',
	...
	var UpgradeView = Backbone.View.extend({
		...
		initialize: function () {
			this.listenTo(this.model, 'change:earned', this.render);
			this.listenTo(AppModel, 'volts', this.render);
...
define('views/AppView',['jquery', 'underscore', 'backbone', 'bootbox', 'utils',
	...
	var AppView = Backbone.View.extend({
		...
		initialize: function () {
			...
			this.listenTo(this.model, 'save', this.saveNotify);
...
define('routers/Router',['underscore', 'backbone',
	...
	var initialize = function (options) {
		...
		var view = options.appView;
		
		route.route('', 'main', function () {
			route.view.switchColumn(_.template(a));
		});
		
		route.route('options', 'options', function () {
			route.view.switchColumn(_.template(b));
		});
		
		route.route('stats', 'stats', function () {
			route.view.switchColumn(_.template(c));
		});
